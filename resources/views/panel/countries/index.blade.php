                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            @can('create', \App\Modules\Admin\Location\Models\Country::class)
                                ...
                                @forelse($countries as $country)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @can('viewAny', \App\Modules\Admin\Location\Models\City::class)
                                                <a href="{{ route('admin.cities.index', $country) }}"
                                                   class="btn btn-warning btn-sm mb-2" title="{{ __('Просмотр городов') }}">

<form method="POST"
      action="{{ isset($dish) ? route('restaurant-panel.dishes.update', $dish) : route('restaurant-panel.dishes.store') }}"
    ...
    <div class="form-group mt-2">
        ...
        @if(!empty($dish->image))
            <img src="{{ asset('storage/' . $dish->image) }}" class="img-thumbnail mt-2" width="150">
        @endif
    </div>
